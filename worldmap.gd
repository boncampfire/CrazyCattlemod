...
func _on_ned_pressed() -> void :
    $Worldmap / Uirelease.play()
    get_tree().change_scene_to_file("res://netherlands.tscn")
...
func _on_ned_mouse_entered() -> void :
     if $Worldmap / ned.disabled == false:
        $Worldmap / Uihover.play()
